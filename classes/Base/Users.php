...
abstract class Users implements ActiveRecordInterface
{
    ...
    public function setLastlogin($v)
    {
        ...
        if ($this->lastlogin !== null || $dt !== null) {
            if ($this->lastlogin === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->lastlogin->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UsersTableMap::COL_LASTLOGIN] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsersTableMap::translateFieldName('Lastlogin', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_LASTLOGIN)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_LASTLOGIN)) {
            $criteria->add(UsersTableMap::COL_LASTLOGIN, $this->lastlogin);
        }
