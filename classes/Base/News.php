...
abstract class News implements ActiveRecordInterface
{
    ...
    /**
     * The value for the newtext field.
     *
     * @var        string
     */
    protected $newtext;
    ...
    public function getDatecreation($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->datecreation instanceof \DateTimeInterface ? $this->datecreation->format($format) : null;
        }
    }
    ...
    /**
     * Set the value of [newtext] column.
     *
     * @param string $v new value
     * @return $this|\News The current object (for fluent API support)
     */
    public function setNewtext($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->newtext !== $v) {
            $this->newtext = $v;
            $this->modifiedColumns[NewsTableMap::COL_NEWTEXT] = true;
        }
    ...
    public function setDatecreation($v)
    {
        ...
        if ($this->datecreation !== null || $dt !== null) {
            if ($this->datecreation === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->datecreation->format("Y-m-d H:i:s.u")) {
                $this->datecreation = $dt === null ? null : clone $dt;
                $this->modifiedColumns[NewsTableMap::COL_DATECREATION] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : NewsTableMap::translateFieldName('Newtext', TableMap::TYPE_PHPNAME, $indexType)];
            $this->newtext = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : NewsTableMap::translateFieldName('Datecreation', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->datecreation = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_NEWTEXT)) {
            $modifiedColumns[':p' . $index++]  = 'newText';
        }
        if ($this->isColumnModified(NewsTableMap::COL_DATECREATION)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'title':
                        ...
                        break;
                    case 'newText':
                        $stmt->bindValue($identifier, $this->newtext, PDO::PARAM_STR);
                        break;
                    case 'dateCreation':
                        $stmt->bindValue($identifier, $this->datecreation ? $this->datecreation->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_NEWTEXT)) {
            $criteria->add(NewsTableMap::COL_NEWTEXT, $this->newtext);
        }
        if ($this->isColumnModified(NewsTableMap::COL_DATECREATION)) {
            $criteria->add(NewsTableMap::COL_DATECREATION, $this->datecreation);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNewtext($this->getNewtext());
