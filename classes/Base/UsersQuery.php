 ...
 * @method     ChildUsersQuery orderByLastlogin($order = Criteria::ASC) Order by the lastlogin column
 *
 ...
 * @method     ChildUsersQuery groupByLastlogin() Group by the lastlogin column
 *
 ...
 * @method     ChildUsers findOneByLastlogin(string $lastlogin) Return the first ChildUsers filtered by the lastlogin column *
 ...
 * @method     ChildUsers requireOneByLastlogin(string $lastlogin) Return the first ChildUsers filtered by the lastlogin column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsers[]|ObjectCollection findByLastlogin(string $lastlogin) Return ChildUsers objects filtered by the lastlogin column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, username, password, lastlogin FROM users WHERE id = :p0';
        try {
    ...
    public function filterByLastlogin($lastlogin = null, $comparison = null)
    {
        if (is_array($lastlogin)) {
            ...
            if (isset($lastlogin['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_LASTLOGIN, $lastlogin['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lastlogin['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_LASTLOGIN, $lastlogin['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_LASTLOGIN, $lastlogin, $comparison);
    }
