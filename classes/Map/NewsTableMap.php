...
class NewsTableMap extends TableMap
{
     ...
     */
    const COL_TITLE = 'news.title';

    /**
     * the column name for the newText field
     */
    const COL_NEWTEXT = 'news.newText';

    /**
     * the column name for the dateCreation field
     */
    const COL_DATECREATION = 'news.dateCreation';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Newtext', 'Datecreation', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'newtext', 'datecreation', ),
        self::TYPE_COLNAME       => array(NewsTableMap::COL_ID, NewsTableMap::COL_TITLE, NewsTableMap::COL_NEWTEXT, NewsTableMap::COL_DATECREATION, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'newText', 'dateCreation', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Newtext' => 2, 'Datecreation' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'newtext' => 2, 'datecreation' => 3, ),
        self::TYPE_COLNAME       => array(NewsTableMap::COL_ID => 0, NewsTableMap::COL_TITLE => 1, NewsTableMap::COL_NEWTEXT => 2, NewsTableMap::COL_DATECREATION => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'newText' => 2, 'dateCreation' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('title', 'Title', 'VARCHAR', true, 240, null);
        $this->addColumn('newText', 'Newtext', 'LONGVARCHAR', false, null, null);
        $this->addColumn('dateCreation', 'Datecreation', 'TIMESTAMP', true, null, 'CURRENT_TIMESTAMP');
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsTableMap::COL_NEWTEXT);
            $criteria->addSelectColumn(NewsTableMap::COL_DATECREATION);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.title');
            $criteria->addSelectColumn($alias . '.newText');
